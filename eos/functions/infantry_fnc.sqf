...
for "_x" from 1 to _grpSize do {					
		...
		_unit enableSimulationGlobal false; _unit disableAI "ANIM"; _unit disableAI "FSM"; _unit disableAI "MOVE"; _unit disableAI "SUPPRESSION"; _unit disableAI "AIMINGERROR"; _unit disableAI "TARGET"; _unit disableAI "AUTOTARGET"; _unit setSpeaker "NoVoice"; _unit disableConversation true;		
	};
