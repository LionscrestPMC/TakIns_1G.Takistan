...
Credit:	Credit to zooloo75 for the stumble mechanics.
*/
...
QS_fatigue_classes_highStamina = compileFinal '[
	"B_medic_F","B_Soldier_F","B_soldier_UAV_F","B_recon_exp_F","B_recon_medic_F",
	"B_recon_medic_F","B_recon_M_F","B_recon_F","B_recon_JTAC_F","B_recon_TL_F",
	"B_Soldier_GL_F","B_HeavyGunner_F","B_engineer_F","B_Soldier_SL_F"]';
